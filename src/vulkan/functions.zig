...
pub const allocateCommandBuffers = f("vkAllocateCommandBuffers", fn (device: Device, alloc_info: *const vk.CommandBufferAllocateInfo, command_buffer: *CommandBuffer) callconv(.C) Result);
