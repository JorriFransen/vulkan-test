...
const ImageLayout = vk.ImageLayout;
...
pub const createImage = f("vkCreateImage", fn (device: Device, pCreateInfo: *const vk.ImageCreateInfo, pAllocator: ?*const AllocationCallbacks, pImage: *Image) callconv(.C) Result);
pub const getImageMemoryRequirements = f("vkGetImageMemoryRequirements", fn (device: Device, image: Image, pMemoryRequirements: *vk.MemoryRequirements) callconv(.C) void);
pub const destroyImage = f("vkDestroyImage", fn (device: Device, image: Image, pAllocator: ?*const AllocationCallbacks) callconv(.C) void);
pub const bindImageMemory = f("vkBindImageMemory", fn (device: Device, image: Image, memory: DeviceMemory, memoryOffset: vk.DeviceSize) callconv(.C) Result);
...
pub const cmdCopyBufferToImage = f("vkCmdCopyBufferToImage", fn (commandBuffer: CommandBuffer, srcBuffer: Buffer, dstImage: Image, dstImageLayout: ImageLayout, regionCount: u32, pRegions: [*]const vk.BufferImageCopy) callconv(.C) void);
...
pub const cmdBlitImage = f("vkCmdBlitImage", fn (command_buffer: CommandBuffer, src_image: Image, src_image_layout: ImageLayout, dst_image: Image, dst_image_layout: ImageLayout, region_count: u32, regions: [*]const vk.ImageBlit, filter: vk.Filter) callconv(.C) void);
