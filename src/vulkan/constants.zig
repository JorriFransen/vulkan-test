...
pub const BufferCreateFlags = packed struct(Flags) {
    SPARSE_BINDING_BIT: u1 = 0, //  1
    SPARSE_RESIDENCY_BIT: u1 = 0, //  2
    SPARSE_ALIASED_BIT: u1 = 0, //  4
    PROTECTED_BIT: u1 = 0, //  8
    DEVICE_ADDRESS_CAPTURE_REPLAY_BIT: u1 = 0, //  16
    DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT: u1 = 0, //  32
    VIDEO_PROFILE_INDEPENDENT_BIT_KHR: u1 = 0, //  64
    __reserved: u25 = 0,
    pub const DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT: @This() = .{ .DEVICE_ADDRESS_CAPTURE_REPLAY_BIT = 1 };
    pub const DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR: @This() = .{ .DEVICE_ADDRESS_CAPTURE_REPLAY_BIT = 1 };
};

pub const BufferUsageFlags = packed struct(Flags) {
    TRANSFER_SRC_BIT: u1 = 0, //  0x00000001
    TRANSFER_DST_BIT: u1 = 0, //  0x00000002
    UNIFORM_TEXEL_BUFFER_BIT: u1 = 0, //  0x00000004
    STORAGE_TEXEL_BUFFER_BIT: u1 = 0, //  0x00000008
    UNIFORM_BUFFER_BIT: u1 = 0, //  0x00000010
    STORAGE_BUFFER_BIT: u1 = 0, //  0x00000020
    INDEX_BUFFER_BIT: u1 = 0, //  0x00000040
    VERTEX_BUFFER_BIT: u1 = 0, //  0x00000080
    INDIRECT_BUFFER_BIT: u1 = 0, //  0x00000100
    CONDITIONAL_RENDERING_BIT_EXT: u1 = 0, //  0x00000200
    SHADER_BINDING_TABLE_BIT_KHR: u1 = 0, //  0x00000400
    TRANSFORM_FEEDBACK_BUFFER_BIT_EXT: u1 = 0, //  0x00000800
    TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT: u1 = 0, //  0x00001000
    VIDEO_DECODE_SRC_BIT_KHR: u1 = 0, //  0x00002000
    VIDEO_DECODE_DST_BIT_KHR: u1 = 0, //  0x00004000
    VIDEO_ENCODE_DST_BIT_KHR: u1 = 0, //  0x00008000
    VIDEO_ENCODE_SRC_BIT_KHR: u1 = 0, //  0x00010000
    SHADER_DEVICE_ADDRESS_BIT: u1 = 0, //  0x00020000
    __reserved_1: u1 = 0,
    ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR: u1 = 0, //  0x00080000
    ACCELERATION_STRUCTURE_STORAGE_BIT_KHR: u1 = 0, //  0x00100000
    SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT: u1 = 0, //  0x00200000
    RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT: u1 = 0, //  0x00400000
    MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT: u1 = 0, //  0x00800000
    MICROMAP_STORAGE_BIT_EXT: u1 = 0, //  0x01000000
    EXECUTION_GRAPH_SCRATCH_BIT_AMDX: u1 = 0, //  0x02000000
    PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER_BIT_EXT: u1 = 0, //  0x04000000
    __reserved_2: u5 = 0,
    pub const RAY_TRACING_BIT_NV: @This() = .{ .SHADER_BINDING_TABLE_BIT_KHR = 1 };
    pub const SHADER_DEVICE_ADDRESS_BIT_EXT: @This() = .{ .SHADER_DEVICE_ADDRESS_BIT = 1 };
    pub const SHADER_DEVICE_ADDRESS_BIT_KHR: @This() = .{ .SHADER_DEVICE_ADDRESS_BIT = 1 };
};

pub const MemoryPropertyFlags = packed struct(Flags) {
    DEVICE_LOCAL_BIT: u1 = 0, //  0x00000001
    HOST_VISIBLE_BIT: u1 = 0, //  0x00000002
    HOST_COHERENT_BIT: u1 = 0, //  0x00000004
    HOST_CACHED_BIT: u1 = 0, //  0x00000008
    LAZILY_ALLOCATED_BIT: u1 = 0, //  0x00000010
    PROTECTED_BIT: u1 = 0, //  0x00000020
    DEVICE_COHERENT_BIT_AMD: u1 = 0, //  0x00000040
    DEVICE_UNCACHED_BIT_AMD: u1 = 0, //  0x00000080
    RDMA_CAPABLE_BIT_NV: u1 = 0, //  0x00000100
    __reserved: u23 = 0,
};

pub const MemoryHeapFlags = packed struct(Flags) {
    DEVICE_LOCAL_BIT: u1 = 0, //  0x00000001
    MULTI_INSTANCE_BIT: u1 = 0, //  0x00000002
    __reserved: u30 = 0,
    pub const MULTI_INSTANCE_BIT_KHR: @This() = .{ .MULTI_INSTANCE_BIT = 1 };
};
...
pub const DescriptorType = enum(c_int) {
    ...
    pub const INLINE_UNIFORM_BLOCK_EXT = .INLINE_UNIFORM_BLOCK;
    pub const MUTABLE_VALVE = .MUTABLE_EXT;
};

pub const DescriptorSetLayoutCreateFlags = packed struct(Flags) {
    PUSH_DESCRIPTOR_BIT: u1 = 0, // 0x00000001
    UPDATE_AFTER_BIND_POOL_BIT: u1 = 0, // 0x00000002
    HOST_ONLY_POOL_BIT_EXT: u1 = 0, // 0x00000004
    __reserved_1: u1 = 0,
    DESCRIPTOR_BUFFER_BIT_EXT: u1 = 0, // 0x00000010
    EMBEDDED_IMMUTABLE_SAMPLERS_BIT_EXT: u1 = 0, // 0x00000020
    PER_STAGE_BIT_NV: u1 = 0, // 0x00000040
    INDIRECT_BINDABLE_BIT_NV: u1 = 0, // 0x00000080
    __reserved_2: u24 = 0,
    pub const PUSH_DESCRIPTOR_BIT_KHR = .VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT;
    pub const UPDATE_AFTER_BIND_POOL_BIT_EXT = .VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT;
...
pub const FormatFeatureFlags = packed struct(Flags) {
    SAMPLED_IMAGE_BIT: u1 = 0, // 0x00000001
    STORAGE_IMAGE_BIT: u1 = 0, // 0x00000002
    STORAGE_IMAGE_ATOMIC_BIT: u1 = 0, // 0x00000004
    UNIFORM_TEXEL_BUFFER_BIT: u1 = 0, // 0x00000008
    STORAGE_TEXEL_BUFFER_BIT: u1 = 0, // 0x00000010
    STORAGE_TEXEL_BUFFER_ATOMIC_BIT: u1 = 0, // 0x00000020
    VERTEX_BUFFER_BIT: u1 = 0, // 0x00000040
    COLOR_ATTACHMENT_BIT: u1 = 0, // 0x00000080
    COLOR_ATTACHMENT_BLEND_BIT: u1 = 0, // 0x00000100
    DEPTH_STENCIL_ATTACHMENT_BIT: u1 = 0, // 0x00000200
    BLIT_SRC_BIT: u1 = 0, // 0x00000400
    BLIT_DST_BIT: u1 = 0, // 0x00000800
    SAMPLED_IMAGE_FILTER_LINEAR_BIT: u1 = 0, // 0x00001000
    SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT: u1 = 0, // 0x00002000
    TRANSFER_SRC_BIT: u1 = 0, // 0x00004000
    TRANSFER_DST_BIT: u1 = 0, // 0x00008000
    SAMPLED_IMAGE_FILTER_MINMAX_BIT: u1 = 0, // 0x00010000
    MIDPOINT_CHROMA_SAMPLES_BIT: u1 = 0, // 0x00020000
    SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT: u1 = 0, // 0x00040000
    SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT: u1 = 0, // 0x00080000
    SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT: u1 = 0, // 0x00100000
    SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT: u1 = 0, // 0x00200000
    DISJOINT_BIT: u1 = 0, // 0x00400000
    COSITED_CHROMA_SAMPLES_BIT: u1 = 0, // 0x00800000
    FRAGMENT_DENSITY_MAP_BIT_EXT: u1 = 0, // 0x01000000
    VIDEO_DECODE_OUTPUT_BIT_KHR: u1 = 0, // 0x02000000
    VIDEO_DECODE_DPB_BIT_KHR: u1 = 0, // 0x04000000
    VIDEO_ENCODE_INPUT_BIT_KHR: u1 = 0, // 0x08000000
    VIDEO_ENCODE_DPB_BIT_KHR: u1 = 0, // 0x10000000
    ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR: u1 = 0, // 0x20000000
    FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR: u1 = 0, // 0x40000000
    __reserved: u1 = 0,
    pub const SAMPLED_IMAGE_FILTER_CUBIC_BIT_IMG = .{ .SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT = 1 };
    pub const TRANSFER_SRC_BIT_KHR = .{ .TRANSFER_SRC_BIT = 1 };
    pub const TRANSFER_DST_BIT_KHR = .{ .TRANSFER_DST_BIT = 1 };
    pub const SAMPLED_IMAGE_FILTER_MINMAX_BIT_EXT = .{ .SAMPLED_IMAGE_FILTER_MINMAX_BIT = 1 };
    pub const MIDPOINT_CHROMA_SAMPLES_BIT_KHR = .{ .MIDPOINT_CHROMA_SAMPLES_BIT = 1 };
    pub const SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR = .{ .SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT = 1 };
    pub const SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR = .{ .SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT = 1 };
    pub const SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR = .{ .SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT = 1 };
    pub const SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR = .{ .SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT = 1 };
    pub const DISJOINT_BIT_KHR = .{ .DISJOINT_BIT = 1 };
    pub const COSITED_CHROMA_SAMPLES_BIT_KHR = .{ .COSITED_CHROMA_SAMPLES_BIT = 1 };
};
